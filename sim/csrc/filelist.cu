...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _24941_archive_1.so
_24941_archive_1.so : archive.1/_24941_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_24941_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_24941_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _65451_archive_1.so
_65451_archive_1.so : archive.6/_65451_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_65451_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_65451_archive_1.so $@

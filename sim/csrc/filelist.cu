...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _74455_archive_1.so
_74455_archive_1.so : archive.280/_74455_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_74455_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_74455_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _104365_archive_1.so
_104365_archive_1.so : archive.339/_104365_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_104365_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_104365_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.339/_prev_archive_1.a
	@$(AR) -s $<

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _16349_archive_1.so
_16349_archive_1.so : archive.11/_16349_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_16349_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_16349_archive_1.so $@

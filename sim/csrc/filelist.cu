...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _121233_archive_1.so
_121233_archive_1.so : archive.357/_121233_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_121233_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_121233_archive_1.so $@

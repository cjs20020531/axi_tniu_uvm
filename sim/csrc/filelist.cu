...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _2896_archive_1.so
_2896_archive_1.so : archive.284/_2896_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_2896_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_2896_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.284/_prev_archive_1.a
	@$(AR) -s $<

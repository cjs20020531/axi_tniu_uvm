...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _113851_archive_1.so
_113851_archive_1.so : archive.374/_113851_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_113851_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_113851_archive_1.so $@

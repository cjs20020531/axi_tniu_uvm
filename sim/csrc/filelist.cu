...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _25987_archive_1.so
_25987_archive_1.so : archive.12/_25987_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_25987_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_25987_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _128427_archive_1.so
_128427_archive_1.so : archive.257/_128427_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_128427_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_128427_archive_1.so $@

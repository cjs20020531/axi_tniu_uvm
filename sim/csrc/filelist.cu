...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _80561_archive_1.so
_80561_archive_1.so : archive.10/_80561_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_80561_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_80561_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _129764_archive_1.so
_129764_archive_1.so : archive.9/_129764_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_129764_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_129764_archive_1.so $@

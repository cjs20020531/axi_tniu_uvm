...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _122314_archive_1.so
_122314_archive_1.so : archive.255/_122314_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_122314_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_122314_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _34489_archive_1.so
_34489_archive_1.so : archive.265/_34489_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_34489_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_34489_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.265/_prev_archive_1.a
	@$(AR) -s $<

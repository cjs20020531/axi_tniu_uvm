...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _9168_archive_1.so
_9168_archive_1.so : archive.259/_9168_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_9168_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_9168_archive_1.so $@

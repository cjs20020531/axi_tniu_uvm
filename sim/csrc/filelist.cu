...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _60778_archive_1.so
_60778_archive_1.so : archive.310/_60778_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_60778_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_60778_archive_1.so $@

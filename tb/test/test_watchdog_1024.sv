`ifndef TEST_WATCHDOG_1024_SV
`define TEST_WATCHDOG_1024_SV

class test_watchdog_1024 extends axi_tniu_base_test;
  `uvm_component_utils(test_watchdog_1024)
  ...
  virtual function void configure_cfg();
    ...
    cfg.axi_min_resp_delay  = 10240;
    cfg.axi_max_resp_delay  = 10240;
...
endclass : test_watchdog_1024

`endif // TEST_WATCHDOG_1024_SV

`ifndef TEST_WATCHDOG_1023_SV
`define TEST_WATCHDOG_1023_SV

class test_watchdog_1023 extends axi_tniu_base_test;
  `uvm_component_utils(test_watchdog_1023)
...
endclass : test_watchdog_1023

`endif // TEST_WATCHDOG_1023_SV

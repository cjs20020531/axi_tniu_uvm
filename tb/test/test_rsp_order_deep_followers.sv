...
class test_rsp_order_deep_followers extends axi_tniu_base_test;
  ...
  virtual function void configure_cfg();
    ...
    // Make the coverage condition deterministic:
    // - no random request/response backpressure;
    // - one long AXI read response;
    // - fixed delay/gap gives enough time to fill deep special-buffer slots.
    ...
    cfg.axi_min_resp_delay    = 12;
    cfg.axi_max_resp_delay    = 12;
    cfg.axi_min_beat_gap      = 3;
